...
public class GRTileEntities
{
    ...
    public static void init() {
    	DISASSEMBLER[0] = GregTechAPI.registerMetaTileEntity(3000, new SimpleMachineMetaTileEntity(location("disassembler.lv"), GRRecipeMaps.DISASSEMBLER_LV, Textures.ASSEMBLER_OVERLAY, 1));
    	DISASSEMBLER[1] = GregTechAPI.registerMetaTileEntity(3001, new SimpleMachineMetaTileEntity(location("disassembler.mv"), GRRecipeMaps.DISASSEMBLER_MV, Textures.ASSEMBLER_OVERLAY, 2));
    	DISASSEMBLER[2] = GregTechAPI.registerMetaTileEntity(3002, new SimpleMachineMetaTileEntity(location("disassembler.hv"), GRRecipeMaps.DISASSEMBLER_HV, Textures.ASSEMBLER_OVERLAY, 3));
    	DISASSEMBLER[3] = GregTechAPI.registerMetaTileEntity(3003, new SimpleMachineMetaTileEntity(location("disassembler.ev"), GRRecipeMaps.DISASSEMBLER_EV, Textures.ASSEMBLER_OVERLAY, 4));
    	DISASSEMBLER[4] = GregTechAPI.registerMetaTileEntity(3004, new SimpleMachineMetaTileEntity(location("disassembler.iv"), GRRecipeMaps.DISASSEMBLER_IV, Textures.ASSEMBLER_OVERLAY, 5));
    	
    	DISASSEMBLER[5] = GregTechAPI.registerMetaTileEntity(3005, new SimpleMachineMetaTileEntity(location("disassembler.luv"), GRRecipeMaps.DISASSEMBLER_IV, Textures.ASSEMBLER_OVERLAY, 6));
    	DISASSEMBLER[6] = GregTechAPI.registerMetaTileEntity(3006, new SimpleMachineMetaTileEntity(location("disassembler.zpm"), GRRecipeMaps.DISASSEMBLER_IV, Textures.ASSEMBLER_OVERLAY, 7));
    	DISASSEMBLER[7] = GregTechAPI.registerMetaTileEntity(3007, new SimpleMachineMetaTileEntity(location("disassembler.uv"), GRRecipeMaps.DISASSEMBLER_IV, Textures.ASSEMBLER_OVERLAY, 8));
