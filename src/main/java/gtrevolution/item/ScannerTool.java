...
public class ScannerTool extends ToolMetaItem<ToolMetaItem<?>.MetaToolValueItem>
{
    ...
    {
        super();
        this.addPropertyOverride(new ResourceLocation("progress"), (stack, worldIn, entityIn) -> {
        ...
        this.addPropertyOverride(new ResourceLocation("using"), (stack, worldIn, entityIn) -> entityIn != null && entityIn.isHandActive() && entityIn.getActiveItemStack() == stack ? 1.0F : 0.0F);
    }
