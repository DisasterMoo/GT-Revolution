...
public class GRMaterials implements IMaterialHandler {
    ...
    public static FluidMaterial Iron3Chloride,
								BacterialGrowth;
    ...
    static {
		...
		if(GRConfig.misc.CircuitOverhaul){
			Iron3Chloride = new FluidMaterial(677, "iron3chloride", 0x111216, MaterialIconSet.FLUID, ImmutableList.of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
			BacterialGrowth = new FluidMaterial(676, "bacterialgrowth", 0xA37E64, MaterialIconSet.FLUID, ImmutableList.of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
